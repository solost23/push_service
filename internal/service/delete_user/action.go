...
func (a *Action) Deal(_ context.Context, request *user_service.DeleteUserRequest) (reply *user_service.DeleteUserResponse, err error) {
	// 业务逻辑
	reply = &user_service.DeleteUserResponse{
